    ...
    <div id="Home" className="border-b border-neutral-900 pb-4 lg:mb-35 mt-20">
        <div className="flex flex-wrap ">
          ...
          <div className="flex justify-between">
            <motion.img initial={{x:100, opacity:0}} animate={{x:0,opacity:1}} transition={{duration:1, delay:1.2}} className="rounded-2xl" src={profilePic} alt="Navya Nagabhiru" style={{float:'right'}}/>
          </div>
        </div>
      </div>
    </div>
